...
class AiChatControllerTest {
    ...
    private static final String VALID_SESSION_COOKIE = "test-session-uuid";
    ...
    void 정상_요청시_201과_세션_id_를_반환한다() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/ai-chat/chat-sessions")
    ...
    @Test
    void 유효하지_않은_세션_쿠키면_401을_반환한다() throws Exception {
