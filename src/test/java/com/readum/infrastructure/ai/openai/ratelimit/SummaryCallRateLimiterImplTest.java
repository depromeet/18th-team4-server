...
class SummaryCallRateLimiterImplTest {
    ...
    void 충분한_예산이면_즉시_통과한다() {
        SummaryCallRateLimiterImpl limiter =
                new SummaryCallRateLimiterImpl(new SummaryRateLimitProperties(60, 100_000, 1024));
    ...
    void 예상토큰이_TPM용량을_초과해도_클램프되어_매달리지_않는다() {
        SummaryCallRateLimiterImpl limiter =
                new SummaryCallRateLimiterImpl(new SummaryRateLimitProperties(60, 1_000, 1024));
