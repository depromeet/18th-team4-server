...
| 스트리밍 기한·버퍼 (`ai-chat.streaming`) | **재측정(2026-09-06) 뒤에도 모두 후보값** — 그 측정에서 기한이 하나도 발동하지 않아 조정 근거가 나오지 않았다. 생성 전체 120초 / 무응답 30초 / 전달 150초 / 종료 대기 60초, 연결당 전달 큐 256건. 여유 둘(선행 60초·후처리 60초)은 기한이 아니라 요청 만료 시각 산식에만 쓴다 |
